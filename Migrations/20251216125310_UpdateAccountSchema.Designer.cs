...
namespace expense_tracker.Migrations
{
    ...
    [Migration("20251216125310_UpdateAccountSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("expense_tracker.Models.Transfer", b =>
                {
            ...
            modelBuilder.Entity("expense_tracker.Models.Transfer", b =>
                {
                    b.HasOne("expense_tracker.Models.Account", "SourceAccount")
                        .WithMany()
                        .HasForeignKey("SourceAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("expense_tracker.Models.Account", "TargetAccount")
                        .WithMany()
